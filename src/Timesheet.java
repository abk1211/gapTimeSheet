...
public class Timesheet {
	...
	private static void filldetails(String strTimesheetTable, int a, int b, Properties objpProp) {
		...
		for(int j=8; j<=table_colomns; j++) {
			...
			String inputtags = web_OutOfOffice.getAttribute("title");
			log.info(inputtags);
			web_Baseline_1.clear();
			web_Baseline_2.clear();
			web_OutOfOffice.clear();

			if(inputtags.contains("Mon") && !web_OutOfOffice.getAttribute("class").contains("ppm_res_cal_non_working")) {
			...
			else if(inputtags.contains("Tue") && !web_OutOfOffice.getAttribute("class").contains("ppm_res_cal_non_working")) {
			...
			else if(inputtags.contains("Wed") && !web_OutOfOffice.getAttribute("class").contains("ppm_res_cal_non_working")) {
			...
			else if(inputtags.contains("Thu") && !web_OutOfOffice.getAttribute("class").contains("ppm_res_cal_non_working")) {
			...
			else if(inputtags.contains("Fri") && !web_OutOfOffice.getAttribute("class").contains("ppm_res_cal_non_working")) {
